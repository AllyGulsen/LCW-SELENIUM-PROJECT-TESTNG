...
public class CompleteTest extends BaseDriver {
    ...
    public void navigateToCocukAksesuarPage(){
        ...
        Assert.assertEquals(currentStarWarsCantaProductPageUrl,expectedStarWarsCantaProductPageUrl);
    }
        @Test(priority = 5)
        ...
        wait.until(ExpectedConditions.elementToBeClickable(productPage_elements.standartSize));
        productPage_elements.standartSize.click();

        wait.until(ExpectedConditions.elementToBeClickable(productPage_elements.starWarsCantaAddToCartButton));
        productPage_elements.starWarsCantaAddToCartButton.click();
